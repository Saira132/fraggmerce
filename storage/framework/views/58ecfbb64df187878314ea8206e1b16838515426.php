...
<body>
    ...
    <!-- start #header -->
        ...
        <br>
        <h1 class="display-4 section-heading form-gap mb-4 mt-4 text-center"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-ctBWKnZtA9oPo3kzaTNV7U7njhKocc_0hV0OcfYqokVIudRwOjsbLC7q_qC3n5hVCe4&usqp=CAU" width="90px" height="auto"></h1>
        <br>
          <section id="search-card">
        <div class="card container w-75" style="background-color: #faf4fa">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn2" id="search-btn-emper">Search</button>
                        </div>
                    </div>
         ...
         <!-- Special Price -->
          <section id="special-price">
            <div class="container">
              ...
              <div class="row">
              <?php $__currentLoopData = $products_emper; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/womenBrands/emper.blade.php ENDPATH**/ ?>