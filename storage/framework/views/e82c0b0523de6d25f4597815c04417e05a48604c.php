            ...
            <nav class="navbar navbar-expand-lg navbar-dark color-second-bg" style="background-color: #c96;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <form action="#" class="font-size-14 font-rale">
                      <a href="<?php echo e(url('cart')); ?>" class="py-2 rounded-pill color-primary-bg">
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/front/layout.blade.php ENDPATH**/ ?>