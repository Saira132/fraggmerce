        ...
        <div class="card container w-75" style="background-color: #faf4fa">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn2" id="search-btn-nina">Search</button>
                        </div>
                    </div>
                 ...
                 <div class="item py-2 Apple border mt-5" id="left" style="width: 250px;">
                  <div class="product font-rale">
                    ...
                    <div class="text-center">
                      ...
                      <button type="submit" class="btn font-size-12 btn2">View Details</button></a>
                    </div>
                  </div>
                </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/womenBrands/nina.blade.php ENDPATH**/ ?>