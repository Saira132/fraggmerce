        ...
        <div class="card container w-75" style="background-color: #fefee1">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn1" id="search-btn-arden">Search</button>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/unisexBrands/arden.blade.php ENDPATH**/ ?>