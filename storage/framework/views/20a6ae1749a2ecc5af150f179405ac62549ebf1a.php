        ...
        <div class="card container w-75" style="background-color: #faf4fa">
            ...
            <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn2" id="search-btn-versace">Search</button>
                        </div>
                    </div>
         ...
         <!-- Special Price -->
          <section id="special-price">
            <div class="container">
              ...
              <div class="row">
              <?php $__currentLoopData = $products_versace; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/womenBrands/versace_search.blade.php ENDPATH**/ ?>