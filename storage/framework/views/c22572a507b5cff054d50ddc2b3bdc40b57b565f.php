...
<body>
    ...
    <h1 class="display-4 section-heading form-gap mb-4 mt-4 text-center"><img src="https://www.ifragrance.pk/wp-content/uploads/2017/03/montblanc.png"></h1>
              ...
              <form action="#" method="post" novalidate="novalidate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn-info">Search</button>
                        </div>
                    </div>
         ...
         <!-- Special Price -->
          <section id="special-price">
            <div class="container">
              ...
              <div class="row">
              <?php $__currentLoopData = $products_montblanc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/front/montblanc.blade.php ENDPATH**/ ?>