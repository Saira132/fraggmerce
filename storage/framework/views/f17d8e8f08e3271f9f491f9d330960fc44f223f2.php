...
<body>
    ...
    <!-- start #header -->
        <header id="header">
            ...
            <!-- Primary Navigation -->
            <nav class="navbar navbar-expand-lg navbar-dark color-second-bg" style="background-color: #db7093" >
    ...
    <h1 class="display-4 section-heading form-gap mb-5 mt-5 text-center"><b>Women's Collection</b></h1>
    <div class="container" style="text-align: center;">
      <span style="width:250px; display:inline-block;"><a href="womenCollection/emper"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-ctBWKnZtA9oPo3kzaTNV7U7njhKocc_0hV0OcfYqokVIudRwOjsbLC7q_qC3n5hVCe4&usqp=CAU" width="90px" height="auto"></a></span>
      <span style="width:250px; display:inline-block;"><a href="womenCollection/ysl"><img src="https://www.ifragrance.pk/wp-content/uploads/2017/03/ysl_logo.png"></a></span>
      <span style="width:250px; display:inline-block;"><a href="womenCollection/versace"><img src="https://www.ifragrance.pk/wp-content/uploads/2018/04/versace_logo.jpg"></a></span>
      <span style="width:250px; display:inline-block;"><a href="womenCollection/nina"><img src="https://www.ifragrance.pk/wp-content/uploads/2021/01/nina_ricca-150x150.png"></a></span>
    </div>
                 ...
                 <div class="item py-2 Apple border mt-5" id="left" style="width: 250px;">
                  <div class="product font-rale">
                    ...
                    <div class="text-center">
                      ...
                      <a href="<?php echo e(url('product/'.$product->item_id)); ?>"><button type="submit" class="btn font-size-12 btn2">View Details</button></a>
                    </div>
                  </div>
                </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/collections/womenCollection.blade.php ENDPATH**/ ?>