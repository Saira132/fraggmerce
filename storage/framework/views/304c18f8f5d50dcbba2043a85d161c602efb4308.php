              ...
              <form action="#" method="post" novalidate="novalidate">
                    ...
                    <div class="row" >
                        <div class="col-lg-10 col-md-10 col-sm-12 p-0 mb-3">
                            <input type="text" class="form-control search-slt" placeholder="Search Product">
                        </div>
            
                        <div class="col-lg-2 col-md-2 col-sm-12 p-0 mb-3">
                            <button type="button" class="btn col-12 btn2">Search</button>
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\ecom-app\resources\views/front/emper.blade.php ENDPATH**/ ?>